		...
		<footer className="footer" style={{ padding: '1rem 0' }}>
			<Container>
				<Row>
					<Col className="text-center">
						<p className="text-white mb-0 fs-6">
							Copyright © {new Date().getFullYear()} Novel Pursuit. All rights reserved.
						</p>
					</Col>
				</Row>
				<Row className="justify-content-center">
					...
					<Col xs="auto">
						<a href="mailto:novel.pursuit@fakeemail.com" className="text-white">
							<FaEnvelope size={20} color="#f8f9fa" />
						</a>
					</Col>
					<Col xs="auto">
						<a
							href="https://www.instagram.com/carlsagandotcom/?hl=en"
							target="_blank"
